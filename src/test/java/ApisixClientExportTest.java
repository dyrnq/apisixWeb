    ...
    public void test_export() throws ApisixSDKException, IOException {
        ...
        for (String obj : clss) {
            ...
            for (Object obj1 : list) {
                String id = "";
                if (obj1 instanceof Route) {
                    id = ((Route) obj1).getId();
                } else if (obj1 instanceof Consumer) {
                    id = ((Consumer) obj1).getUsername();
                } else if (obj1 instanceof StreamRoute) {
                    id = ((StreamRoute) obj1).getId();
                } else if (obj1 instanceof Upstream) {
                    id = ((Upstream) obj1).getId();
                } else if (obj1 instanceof Service) {
                    id = ((Service) obj1).getId();
                } else if (obj1 instanceof ConsumerGroup) {
                    id = ((ConsumerGroup) obj1).getId();
                } else if (obj1 instanceof GlobalRule) {
                    id = ((GlobalRule) obj1).getId();
                } else if (obj1 instanceof PluginConfig) {
                    id = ((PluginConfig) obj1).getId();
                } else if (obj1 instanceof Proto) {
                    id = ((Proto) obj1).getId();
                } else if (obj1 instanceof SSL) {
                    id = ((SSL) obj1).getId();
                } else if (obj1 instanceof Secret) {
                    id = URLEncoder.encode(((Secret) obj1).getId(), "UTF-8");
                }
