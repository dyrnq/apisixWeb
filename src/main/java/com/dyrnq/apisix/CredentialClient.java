...
public class CredentialClient extends BaseClient implements Stub<Credential> {

    public static final String PATH = "/apisix/admin/credentials";

    public CredentialClient(Profile profile) {
        super(profile);
    }
    ...
    public Multi<Credential> query(String page, String page_size) throws ApisixSDKException {
        return query(page, page_size, null);
    }

    public Multi<Credential> query(String page, String page_size, Map<String, String> qp) throws ApisixSDKException {
        Multi<Credential> rsp = null;
        try {
    ...
    public List<Credential> list() throws ApisixSDKException {
        ...
        List<Credential> result = this.arrangeMulti(rsp.getNodes());
        return result;
    }
    ...
    public Credential patchRaw(String id, String rawData) throws ApisixSDKException {
        Wrap<Credential> rsp = null;
        try {
            Type type = new TypeToken<Wrap<Credential>>() {}.getType();
    ...
    public Credential post(Credential obj) throws ApisixSDKException {
        Wrap<Credential> rsp = null;
        try {
            Type type = new TypeToken<Wrap<Credential>>() {}.getType();
