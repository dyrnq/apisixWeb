...
function addLink(d) {
  ...
  if (addLink.length > 0) {
    ...
    let dropBtn =
      ...
      '</button>'
    let exptBtn =
      '<button type="button" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="export">' +
      commonStr.export +
      '</button>'
    let imptBtn =
    ...
    let config =
      '<button type="button" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="config">' +
      commonStr.config +
      '</button>'
    let reload =
      '<button type="button" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="reload">' +
      commonStr.reload +
      '</button>'
    let stop =
      '<button type="button" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="stop">' +
      commonStr.stop +
      '</button>'
    let start =
      '<button type="button" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="start">' +
      commonStr.start +
      '</button>'
    let restart =
      '<button type="button" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="restart">' +
      commonStr.restart +
      '</button>'
    return (
      editBtn +
...
layui.use(function () {
  ...
  table.on('tool(test)', function (obj) {
    ...
    } else if (layEvent === 'importData') {
      //导入事件
      $('#addForm3 input[name="id"]').val(obj.data.id)
      $('#addForm3')
        .find('.layui-upload-choose')
