...
function plugin_metadata(d) {
  ...
  if (addLink.length > 0) {
    ...
    let bt1 =
      '<button class="layui-btn layui-btn-danger layui-btn-xs" lay-event="setting" >' + commonStr.setting + '</button>'
    let bt2 =
      '<a class="layui-btn layui-btn-normal layui-btn-xs" href="https://apisix.apache.org/zh/docs/apisix/plugins/' +
      addLink +
      '/" target="_blank">' +
      commonStr.help +
      '</a>'
...
function consumer_schema(d) {
  ...
  return (
    '<button class="layui-btn layui-btn-normal layui-btn-xs" lay-event="detail_consumer_schema">' +
    commonStr.view +
    '</button>'
  )
}
...
function metadata_schema(d) {
  ...
  return (
    '<button class="layui-btn layui-btn-normal layui-btn-xs" lay-event="detail_metadata_schema">' +
    commonStr.view +
    '</button>'
  )
}
