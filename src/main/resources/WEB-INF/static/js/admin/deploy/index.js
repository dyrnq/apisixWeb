layui.use(function () {
  ...
  function addLink(d) {
    ...
    if (addLink.length > 0) {
      ...
      if (d.state == 1) {
        opBtn =
          '<button type="button" class="layui-btn layui-btn layui-btn-xs" lay-event="undeploy">' +
          commonStr.undeploy +
          '</button>'
      } else {
        opBtn =
          '<button type="button" class="layui-btn layui-btn-normal layui-btn-xs" lay-event="deploy">' +
          commonStr.deploy +
          '</button>'
      }
      let delBtn =
