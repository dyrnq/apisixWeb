  ...
  table.render({
    ...
    cols: [
      [
        ...
        { field: 'desc', title: 'desc', hide: defaultHidden },
        { field: 'host', title: 'host(s)', templet: host },
        { field: 'uri', title: 'uri(s)', templet: uri },
        {
          field: 'createTime',
          title: 'create_time',
          sort: false,
        ...
        },
        {
          ...
          width: 80,
          templet:
            '<input type="checkbox" name="status" value="{{= d.id }}" title="开|" lay-skin="switch" lay-filter="demo-templet-status" {{= d.status == 1 ? "checked" : "" }}>',
        },
